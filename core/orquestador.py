...
from core.seguridad import requiere_confirmacion, confirmar_con_usuario, registrar_auditoria
...
def ejecutar_orden_texto(texto: str, skills: Optional[dict] = None) -> str:
    """
    ...
    if requiere_confirmacion(skill):
        ...
        # Nivel 1: se registra como auto-confirmado solo si queremos trazabilidad total
        pass
    ...
    if exito:
        # La respuesta hablada viene del Cerebro (más natural); el mensaje de la skill
        # queda en logs. Si la hablada está vacía usamos el mensaje de la skill.
        return respuesta_hablada or mensaje_skill
    else:
        # Si la skill falló, informamos al usuario con el mensaje de la skill
